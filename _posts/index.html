	...
	<body class="is-loading">
		...
		<!-- Wrapper -->
          ...
          <article class="post featured">
            <header class="major">
              <h2><a href="#">前言</a></h2>
              <p>搭建属于自己的博客真的是一件非常奇妙的事情！在搭建过程中会遇到许多让人感到近乎崩溃的事情，但是当博客的雏形成功搭建出来以后，这一切好像就被内心的满足感和愉悦感所替代了。
							</p>
            </header>
						<p>
							尽管搭建博客并不容易，但是如果在中途放弃了，就什么都没有了。只有动手尝试了，才知道自己到底会不会。
						<p>
						</p>
							下面的文章是我学习网页设计与信息可视化以后所归纳的笔记与学习成果，欢迎阅读，如若有不足，请多多指教。
						</p>
					...
					<section class="posts">
						...
						{% assign mod3 = forloop.index | modulo: 3 %}
							<article>
								...
								<p>{{ post.excerpt }}</p>
								<ul class="actions">
									<li><a href="{{ post.url | absolute_url }}" class="button">阅读全文</a></li>
								</ul>
							</article>
							{% if mod3 == 0 %}
							<article>
